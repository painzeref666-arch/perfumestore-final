      ...
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-2">
        ...
        <form onSubmit={login} className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-8">
          ...
          <input
            ...
            className="mt-2 w-full rounded-xl border border-white/10 bg-black px-4 py-4 font-bold text-white outline-none"
          />
          ...
          <button
            disabled={busy}
            className="mt-6 w-full rounded-full bg-amber-700 px-6 py-4 font-black hover:bg-amber-600 disabled:cursor-wait disabled:opacity-60"
          >
